  ...
  fluidPage(
    ...
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        h4( "App Parameters", style = "text-align: center" ),
        
        wellPanel( class = "showmore_1",
          
          selectInput( "home_app_mode_si", "Select the app mode", choices = c( "Business User", "Analyst", "Development" ) ),
          
          div( class = "more",
               
            # span( "You can choose from:", span( class = "dots", "..." ) ),
            span( "You can choose from:" ),
          ...
          a( href = "#", "Option Explanations" )
          
        ),
        
        wellPanel( class = "showmore_1",
          
          selectInput( "home_dataset_version_si", "Select the dataset version", choices = NULL ),
        ...
        tabsetPanel(
          ...
          tabPanel( "Welcome",
            ...
            wellPanel(
              ...
              p( "Welcome to the PCR Predictor Tool. This tool has been designed as a place where HDPE PCR data can be uploaded and analysed." ),
              p( paste0( "If you have any questions, comments or feedback about this tool, please contact Phil Smith via ", email, " who will be happy to hear from you." ) )
          ...
          tabPanel( "Experiment Standards",
            ...
            tabsetPanel(
              ...
              tabPanel( "FTIR",
                ...
                p( "FTIR experiments are conducted" ),
              ...
              tabPanel( "DSC",
                ...
                p( "DSC experiments are conducted" ),
