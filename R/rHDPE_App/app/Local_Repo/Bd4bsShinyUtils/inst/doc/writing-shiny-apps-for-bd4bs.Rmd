...
An example of the custom_metadata_key_values argument is shown below (notes: `CategoryPath` is currently unused and `Date` is calculated using
`as.numeric(as.POSIXct("2014-01-01")) *1000`):
