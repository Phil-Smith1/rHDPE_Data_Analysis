...
def Global_Analysis_Main( directory, ip ):
    ...
    if ip.read_files:
        ...
        features_df, std_of_features_df, rank_features_df = Preprocessing.read_files_and_preprocess( directory, ip.datasets_to_read, ip.sample_mask.copy() )
