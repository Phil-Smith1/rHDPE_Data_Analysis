...
import rHDPE_Data_Analysis.SAXS_Analysis as sa
...
ip = sa.Input_Parameters_Class.Input_Parameters() # Initialise input parameters class.

if read_parameters_from_numbers_file:

    sa.Input_Parameters_Class.read_parameters_from_numbers_file( ip.directory + "Input_Parameters/SAXS_" + parameters_filename + "_Parameters.numbers", ip )
    ...
    ip.data_directory = "/Users/philsmith/Documents/Postdoc/rHDPE_Data_Analysis/Raw_Data/SAXS/" # Directory that contains the raw data.

    ip.output_directory = "/Users/philsmith/Documents/Postdoc/rHDPE_Data_Analysis/Output/" # Directory where outputs are outputted.

    ip.read_files = True # Read the raw files.
    ...
    ip.read_csv = False # Read the .csv file.
    ...
    ip.compute_mean = False # Compute means across specimens of a resin.

    ip.read_mean = False # Read the means from a file.
...
sa.Analysis.SAXS_Analysis_Main( ip )
