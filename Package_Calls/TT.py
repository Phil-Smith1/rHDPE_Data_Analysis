...
ip = tt.Input_Parameters_Class.Input_Parameters() # Initialise input parameters class.

if read_parameters_from_numbers_file:

    tt.Input_Parameters_Class.read_parameters_from_numbers_file( ip.directory + "Input_Parameters/TT_" + parameters_filename + "_Parameters.numbers", ip )
    ...
    ip.data_directory = "/Users/philsmith/Documents/Postdoc/rHDPE_Data_Analysis/Raw_Data/TT/" # Directory that contains the raw data.
    ...
    ip.write_csv = True # Write the desired read data to a .csv file.
