...
ip = da.Input_Parameters_Class.Input_Parameters() # Initialise input parameters class.

if read_parameters_from_numbers_file:

    da.Input_Parameters_Class.read_parameters_from_numbers_file( ip.directory + "Input_Parameters/DSC_" + parameters_filename + "_Parameters.numbers", ip )
    ...
    ip.data_directory = "/Users/philsmith/Documents/Postdoc/rHDPE_Data_Analysis/Raw_Data/DSC/" # Directory that contains the raw data.
    ...
    ip.remove_files_string = "paduz"  # The string of descriptors to remove.
